...
import { getRelatedPostsController, getUserEchoesController, getJournalThreadController } from "../controller/discoveryController.js";
...
router.get('/journal/:journalId/thread', optionalAuth, getJournalThreadController);
